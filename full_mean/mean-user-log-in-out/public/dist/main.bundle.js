...
var UserService = (function () {
    ...
    UserService.prototype.signin = function (user) {
        ...
        return new Promise(function (resolve, reject) {
            _this._http.post('/api/users/login', user)
                .map(function (response) { return response.json(); })
                .toPromise()
                .then(function (data) {
                _this._loggedin = data;
                resolve(data);
            })
                .catch(function (err) {
                reject(err);
...
module.exports = "<div class=\"\">\n    <form #myForm = \"ngForm\" (submit) = \"signin()\" method=\"post\">\n        <label>\n            Username:\n            <input\n                type=\"text\"\n                name=\"username\"\n                [(ngModel)] = \"login.username\"\n                #username = \"ngModel\"\n                required>\n        </label><br>\n\n        <label>\n            Email:\n            <input\n                type=\"text\"\n                name=\"email\"\n                [(ngModel)] = \"login.email\"\n                #email = \"ngModel\"\n                required>\n        </label><br>\n        <input type=\"submit\" name=\"submit\" value=\"Submit\" [disabled] = \"myForm.invalid\">\n    </form>\n</div>\n"
...
var SigninComponent = (function () {
    ...
    // our sign in form
    function SigninComponent(_us, _router) {
        this._us = _us;
...
var WelcomeComponent = (function () {
    function WelcomeComponent(_us, _router) {
        this._us = _us;
        this._router = _router;
    }
    WelcomeComponent.prototype.ngOnInit = function () {
        var user = this._us.isloggedIn();
        if (user) {
            this.user = user;
        }
        else {
